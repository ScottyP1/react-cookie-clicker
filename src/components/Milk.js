        ...
        <div className={classes.content}>
            <svg className={`${classes.waves}`} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                ...
                <g className={` ${classes.parallax}`}>
                    ...
                    <use xlinkHref="#gentle-wave" x="48" y="0" fill="rgba(0,0,67, 0.3)" />
                    <use xlinkHref="#gentle-wave" x="48" y="5" fill="rgba(80, 12, 116, 0.4)" />
                    <use xlinkHref="#gentle-wave" x="48" y="7" fill="rgba(0,0,0, 0.5)" />
                </g>
            </svg>
        </div>
    )
